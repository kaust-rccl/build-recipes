...
LIBWRFLIB = libwrflib.a
 ...
 LIB_EXTERNAL    = \
                      ...
                      -L$(my_netcdfF90lib) -lnetcdff -L$(my_netcdfClib) -lnetcdf\
                      -L$(my_hdflib) -lhdf5hl_fortran -lhdf5_hl -lhdf5_fortran -lhdf5 \
                      $(OASISLIB)
...
SCC             =      ${my_compilerC} 
CCOMP           =      ${my_compilerC} 
DM_FC           =       ${my_mpif90} $(OASISINC)
DM_CC           =       ${my_mpicc} -DMPI2_SUPPORT
FC              =        $(DM_FC)
CC              =       $(DM_CC) -DFSEEKO64_OK 
LD              =       $(FC)
RWORDSIZE       =       $(NATIVE_RWORDSIZE)
PROMOTION       =       # -fdefault-real-8  # uncomment manually
ARCH_LOCAL      =       -DNONSTANDARD_SYSTEM_SUBR $(NETCDF4_IO_OPTS) -DNO_IEEE_MODULE
CFLAGS_LOCAL    =       -w -O3 -c -craype-verbose
LDFLAGS_LOCAL   =       
CPLUSPLUSLIB    =       
...
FCBASEOPTS_NO_G =       -w $(FORMAT_FREE) $(BYTESWAPIO)  -fno-second-underscore
FCBASEOPTS      =       $(FCBASEOPTS_NO_G) $(FCDEBUG) -fallow-argument-mismatch -fallow-invalid-boz -craype-verbose
MODULE_SRCH_FLAG =     
...
ENVCOMPDEFS     =    
WRF_CHEM	=	0 
OASISFLAGS	=	__OASISFLAG__
CPPFLAGS        =    $(ARCHFLAGS) $(ENVCOMPDEFS) -I$(LIBINCLUDE) $(TRADFLAG) $(OASISFLAGS)
NETCDFPATH      = ${NETCDF_DIR}  
NETCDFLIBC      = ${NETCDF_DIR}/lib
NETCDFLIBF      = ${NETCDF_DIR}/lib
...
wrfio_nf : 
	( cd $(WRF_SRC_ROOT_DIR)/external/io_netcdf ; \
          make $(J) NETCDFINC="$(NETCDFINC)" NETCDFLIBF="$(NETCDFLIBF)" NETCDFLIBC="$(NETCDFLIBC)" NETCDFPATH="$(NETCDFPATH)" RANLIB="$(RANLIB)" CPP="$(CPP)" \
